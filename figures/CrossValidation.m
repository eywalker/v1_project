...
% %% Fetch data using much slower but more precisely controlled method
% data_train = [];
% data_test = [];
...
%% Augment the dataset to account for the fact that model id 16 was removed!
data_train = [data_train(:, 1:16), data_train(:, 16:end)];
data_test = [data_test(:, 1:16), data_test(:, 16:end)];
modelNames = [modelNames(1:16); modelNames(16:end)];
