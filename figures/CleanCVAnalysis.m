...
[trainLL, v_jointid, v_lcid, v_decid] = dj.struct.tabulate(data, 'train_mu_logl', 'joint_id', 'lc_id', 'decoder_id');
[testLL, v_jointid_c, v_lcid_c, v_decid_c] = dj.struct.tabulate(data, 'test_mu_logl', 'joint_id', 'lc_id', 'decoder_id');
...
models_to_plot = 1:7; % models to plot in terms of position in the list
