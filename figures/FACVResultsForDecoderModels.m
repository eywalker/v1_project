...
cv_train = pro((cd_dataset.FACrossValidationSets & key) * cd_lc.LCModels * cd_decoder.DecoderModels, cd_lc.TrainedLC * cd_lc.LCTrainSets * cd_dataset.DataSets * cd_dataset.FACVTrainSets, 'avg(lc_train_mu_logl) -> train_mu_logl');
cv_test = pro((cd_dataset.FACrossValidationSets & key) * cd_lc.LCModels * cd_decoder.DecoderModels, cd_lc.LCModelFits * cd_lc.LCTestSets * cd_dataset.DataSets * cd_dataset.FACVTestSets, 'avg(lc_test_mu_logl)->test_mu_logl');
