...
classdef BPLLikelihoodClassifier < TestModel.LikelihoodClassifier.LikelihoodClassifier
    ...
    properties
        ...
        cwExtractor; % function that takes in likelihood and returns its center and width
    end
