...
parpopulate(cd_plc.TrainedPLC, 'plc_trainset_owner = "cd_plset.CleanContrastSessionPLSet"', 'plc_id <=3');
parpopulate(cd_plc.TrainedPLC, 'plc_trainset_owner = "cd_plset.ShuffledPLSets"', 'plc_id <= 3');
