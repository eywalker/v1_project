classdef PeakWidthPSLLC < ClassifierModel.PointBasedLikelihoodClassifier.PSLLC
    % Posterior-Sampling with Lapse rate based Point Based Likelihood Classifier
    ...
    methods
        ...
        function configSet = getModelConfigs(self)
            configSet = getModelConfigs@ClassifierModel.PointBasedLikelihoodClassifier.PSLLC(self);
            configSet.pwExtractorName = func2str(self.pwExtractor);
        end
        
        function setModelConfigs(self, configSet)
            setModelConfigs@ClassifierModel.PointBasedLikelihoodClassifier.PSLLC(self, configSet);
