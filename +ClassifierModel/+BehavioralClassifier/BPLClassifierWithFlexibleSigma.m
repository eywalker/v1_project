classdef BPLClassifierWithFlexibleSigma < ClassifierModel.Classifier
    ...
    properties
        ...
        sigmaList = []; % standard deviation of the sensory noise
        lapseRate = 0; % lapse rate for stimulus category classification
    end
    
    methods (Static)
        function [muLL, listLL] = modelLogLikelihood(sigmaA, sigmaB, priorA, sigmaList, lapseRate, stimCenter, stimulus, contrast, response)
    ...
    methods
        function obj = BPLClassifierWithFlexibleSigma(sigmaA, sigmaB, stimCenter)
