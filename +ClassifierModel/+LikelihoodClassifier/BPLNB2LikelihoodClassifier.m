classdef BPLNB2LikelihoodClassifier < handle
    ...
    methods
        function obj = BPLNB2LikelihoodClassifier(sigmaA, sigmaB, stimCenter)
        ...
        function muLL = train(self, decodeOri, likelihood, classResp, nReps)
            fprintf('Training BPLNB2-likelihood Classifier');
