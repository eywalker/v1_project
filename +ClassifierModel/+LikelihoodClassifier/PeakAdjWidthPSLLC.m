classdef PeakAdjWidthPSLLC < ClassifierModel.LikelihoodClassifier.PointPSLLC
    ...
    methods
        function obj = PeakAdjWidthPSLLC(sigmaA, sigmaB, stimCenter, modelName, pointExtractor)
            ...
            obj = obj@ClassifierModel.LikelihoodClassifier.PointPSLLC(sigmaA, sigmaB, stimCenter, modelName, pointExtractor);
