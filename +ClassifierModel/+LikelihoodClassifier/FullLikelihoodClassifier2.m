classdef FullLikelihoodClassifier2 < handle
    ...
    methods
        function obj = FullLikelihoodClassifier2(sigmaA, sigmaB, stimCenter)
        ...
        function muLL = train(self, decodeOri, likelihood, classResp, nReps)
            fprintf('Training Full-likelihood Classifier');
