%{
class_discrimination.LikelihoodPeakWidthExtractors (manual) # my newest table
...
classdef LikelihoodPeakWidthExtractors < dj.Relvar
    ...
    methods
        ...
        function new_id = registerPWExtractor(self, pwextractor, label)
            ...
            last_id = max(fetchn(class_discrimination.LikelihoodPeakWidthExtractors, 'pwextractor_id'));
            if isempty(last_id)
                last_id = 0;
            end
            new_id = last_id + 1;
