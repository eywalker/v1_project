%{
cd_analysis.BinaryReadout2 (computed) # analysis of binary classification
-> cd_lc.TrainedLC
-----
...
classdef BinaryReadout2 < dj.Relvar & dj.AutoPopulate
    ...
    methods
        function self= BinaryReadout2(varargin)
